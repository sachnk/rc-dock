...
class WindowPanel extends React.PureComponent {
    ...
    render() {
        ...
        return React.createElement(rc_new_window_1.default, { name: name, copyStyles: true, onOpen: this.onOpen, onClose: this.onUnload, onBlock: this.onUnload, initPopupInnerRect: this.initPopupInnerRect, width: w, height: h },
