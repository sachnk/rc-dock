    ...
    render() {
        ...
        return (React.createElement("div", { ref: this.getRef, className: "dock-layout", style: style },
            React.createElement(DockData_1.DockContextProvider, { value: this },
                ...
                React.createElement(WindowBox_1.WindowBox, { boxData: layout.windowbox, onOpened: windowProps.onOpened, onClosing: windowProps.onClosing, getName: windowProps.getName }),
                maximize,
                portals),
